    ...
    <div>
        <center>
            ...
            <p>Hasilnya mohon dikirimkan ke:</p><br>
                <center>
                    <p>PT. KALBE FARMA TBK (HENI- HRD ETH)<br>
                        Jl. LetJend Suprapto Kav. IV Cempaka Putih – Jakarta Pusat 10510<br>
                        Telp.	 : 021 – 42873888 / 89 EXT 1216 <br>
                        HP: 08161.1009.66 <br>
                        EMAIL: monalisa.henriette@kalbe.co.id, imelda.amarta@kalbe.co.id, monica.afria@kalbe.co.id, ika.pramitasari@kalbe.co.id
                    </p>
                </center>
                <br>
