...
function AddDelRiwayat(){
  $('#btnAdd-riwayat').on('click',function(){
    ...
    html +=         "<input type='date' class='form-control' id='ThnMasuk_Rpekerjaan' name='ThnMasuk_Rpekerjaan[]' min=1700 max=2100 required>"
    html +=       "</div>"
    html +=     "</div>"
    html +=     "<div class='col-md-2'>"
    html +=       "<div class='form-group'>"
    html +=         "<label class='form-control-label' for='Rpekerjaan'>Tahun Keluar*</label>"
    html +=         "<input type='date' class='form-control' id='checkrow"+data_riwayat+"' name='ThnKeluar_Rpekerjaan[]' min=1700 max=2100 required>"
    html +=         "<div class='form-check'>"
